...
module LogtoMobile
  class SessionController < ::ApplicationController
    ...
    skip_before_action :check_xhr, only: %i[create destroy health]
    ...
    def create
      ...
      cookies = session_manager.create_session(user)
      ...
      # Return session cookie details (both _t auth token and _forum_session)
      render json: {
               success: true,
    ...
    def validate_client_type
      ...
      if allowed_types.exclude?(client_type)
        render json: {
    ...
    def extract_access_token
      ...
      raise ValidationError, "access_token is required" if access_token.blank?
    ...
    def handle_validation_error(exception)
      ...
      render json: { error: "validation_error", message: exception.message }, status: :unauthorized
    end
    ...
    def handle_generic_error(exception)
      ...
      Rails.logger.error(
        "[LogtoMobileSession] Unexpected error: #{exception.message}\n#{exception.backtrace.join("\n")}",
      )
